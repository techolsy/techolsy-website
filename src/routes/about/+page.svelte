...
<div class="container mx-auto py-5">
  ...
  <p class="{ pTags }">
    But when the workday ends, you'll often find me immersed in music. 
    Whether I'm playing the guitar, experimenting with new melodies, 
    or simply unwinding with my favorite tracks, music is my creative escape. 
    It balances the structure of engineering with the freedom of expression, giving me the best of both worlds.
  </p>
  <p class="{ pTags }">
